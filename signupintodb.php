...
if(mysqli_num_rows($result)>0)
{
	...
	echo 'alert("Account Number already exists please try another !!");window.location="signup.php"';
	echo '</script>';
}
elseif($_POST['pass1']==$_POST['pass2'])
	{	
		...
		$sql2="insert into account_details values($val,'$acc',$_POST[pass2]);";
	...
	{
		echo '<script language="javascript">';
		echo 'alert("Password Mismatch !!");window.location="signup.php"';
		echo '</script>';
	}
?>