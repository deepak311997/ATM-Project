...
<?php
	...
	if (mysqli_num_rows($result)>0) 
	{
		 while($row=mysqli_fetch_assoc($result)) 
		 {
        	...
        	echo "<div align='center' style='margin-top:150px'> <h2><i> The Available Savings Account Balance is " . $row["saving_balance"] . "<br>"."Thank you for Banking with us!"."</i></h2></div>" ."<br>";
    	}
	} 
?>
